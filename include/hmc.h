...
public:
	HMC(const int& MD_steps, const double& trajectory_length, const int& Ntherm, const int& Nmeas, 
		...
		PConf = std::vector<std::vector<std::complex<double>>>(Ntot, std::vector<std::complex<double>>(2, 0));//Momenta PI
		PConf_copy = std::vector<std::vector<std::complex<double>>>(Ntot, std::vector<std::complex<double>>(2, 0));//Momenta PI copy
