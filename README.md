...
This version of the code is also MPI-parallelized, but the halo exchanges is not implemented in a very readable manner, so I refactored the code and merge everything into the main branch. 
