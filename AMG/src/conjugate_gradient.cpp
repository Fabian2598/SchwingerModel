...
//Conjugate gradient for computing D^-1 v, where v is a test vector represented by a matrix
//v[Ntot][2]
c_matrix conjugate_gradient_D(const c_matrix& U, const c_matrix& phi, const double& m0) {
    int max_iter = 100;
    double tol = 1e-10; //maybe I lower the tolerance later
    int k = 0; //Iteration number
    double err = 1;
